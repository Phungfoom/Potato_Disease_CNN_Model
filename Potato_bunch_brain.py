...
def build_combined_model(num_classes):
    ...
    rgb_branch, rgb_target = build_rgb_model(input_shape=(*img_size, 3), num_classes = num_classes)
    gray_branch, gray_target = build_grayscale_model(input_shape=(*img_size, 1), num_classes = num_classes)
    sobel_branch, sobel_target = build_sobel_model(input_shape=(*img_size, 1), num_classes = num_classes)
